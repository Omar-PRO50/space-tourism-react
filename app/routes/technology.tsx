...
export default function Technology() {
  ...
  return (
    <div className="flex min-h-lvh justify-end overflow-hidden bg-(image:--bg-technology-mobile) bg-cover bg-center bg-no-repeat px-300 pt-[calc(var(--spacing-navbar-mobile)+var(--spacing-300))] pb-600 text-white tablet:bg-(image:--bg-technology-tablet) tablet:p-500 tablet:pt-[calc(var(--spacing-navbar-tablet)+var(--spacing-500))] desktop:bg-(image:--bg-technology-desktop) desktop:px-0 desktop:pt-[calc(var(--spacing-navbar-desktop)+var(--spacing-600))] desktop:pb-600">
        ...
        <div className="flex w-full grow flex-col gap-400 pt-16 desktop:flex-row desktop:pt-0">
          <div className="relative grow desktop:order-2">
            ...
            <ImgFadeAnimation
              ...
              className="top-0 left-1/2 hidden size-152 -translate-x-1/2 object-cover desktop:block"
            />
          </div>
